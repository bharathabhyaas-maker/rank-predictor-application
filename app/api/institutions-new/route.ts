...
// Direct environment loading - most reliable approach
const fs = require('fs')
...
try {
  ...
  console.log('✓ Environment variables loaded at module level')
} catch (error) {
...
export async function POST(request: NextRequest) {
  console.log('POST /api/institutions called')
  ...
  try {
    ...
    const institutionId = body.institutionId || generateInstitutionId()
